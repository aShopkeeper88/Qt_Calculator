...
#include "../../BasicCalculator/calculatorlogic.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CalculatorLogic_t, stringdata) + ofs \
...
const QMetaObject CalculatorLogic::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CalculatorLogic.data,
      qt_meta_data_CalculatorLogic,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalculatorLogic.stringdata))
        return static_cast<void*>(const_cast< CalculatorLogic*>(this));
